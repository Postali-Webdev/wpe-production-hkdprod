...
<div class="body-container">
    ...
    <section class="attorney-top">
        <div class="container">
            <p id="breadcrumbs"><span><span><a href="/">Home</a></span> » <span><a href="/about/">About</a></span> » <span class="breadcrumb_last" aria-current="page"><?php the_title(); ?></span></span></p>
            <div class="columns">
                <div class="column-33">
            ...
            <div class="columns">
                <div class="column-full block">
                    ...
                    <div class="bar-admissions-education">
                        <div class="left">
                            <p class="xlarge"><strong>Bar Admissions</strong></p>
                            <?php the_field('bar_admissions'); ?>
                        </div>
                        <div class="right">
                            <p class="xlarge"><strong>Education</strong></p>
                    ...
                    <div class="bar-admissions-education">
                        ...
                        <?php if(get_field('professional_memberships')) { ?>
                            <p class="xlarge"><strong>Professional Associations & Memberships</strong></p>
                            <?php the_field('professional_memberships'); ?>
                        <?php } ?>
                        </div>
                        <div class="right">
                        <?php if(get_field('honors_awards')) { ?>
                            <p class="xlarge"><strong>Honors & Awards</strong></p>
    ...
    <section class="verdicts grey">
        <div class="container">
            ...
            <?php if(get_field('notable_verdicts')) { ?>
                <p class="xlarge"><strong>Notable Verdicts</strong></p>
                <div class="spacer-30"></div>
                <?php 
                ...
                <a href="/case-results/attorney/<?php echo $post_slug; ?>/" class="btn">View <?php echo strtok($first_name, " "); ?>'s Results</a>
                <?php } ?>
