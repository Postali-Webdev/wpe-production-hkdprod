<?php
/*
Template Name: PPC Landing - header options
*/
...
<div class="banner-quote">
    ...
    <div class="author-block">
        ...
        <img src="/wp-content/uploads/2023/11/hkd-header-ppc-google.png" alt="Google Reviews logo" class="testimonial-img" />
        <?php endif; ?>
    </div>
</div>
		...
		<div class="container">
			<div class="columns">
				<div class="column-50 form-left">
                    ...
                    <?php if(in_array('yes', get_field('header_add_call_button'))) { ?>
                    ...
                    <?php if(in_array('yes', get_field('header_add_form'))) { ?>
                        <?php $shortcode = get_field('header_form-shortcode'); ?>
                    <?php } ?>

                    <?php if(in_array('yes', get_field('header_add_form')) && ( get_field('header_form_position') == 'left')) { ?>
                        <div class="form-container_left">
                            <div class="form-headline"><span>FREE</span> Case Review</div>
                            <?php echo do_shortcode($shortcode); ?>
                        </div>
                    <?php } ?>
				</div>

                <div class="column-50 form-right">
                    <?php if(in_array('yes', get_field('header_add_form')) && ( get_field('header_form_position') == 'right')) { ?>
                        <div class="form-container_left">
                            <div class="form-headline"><span>FREE</span> Case Review</div>
                            <?php echo do_shortcode($shortcode); ?>
                        </div>
    ...
    <section id="on-page-cta">
        <div class="container">
            <div class="columns">
                <div class="column-full">
                    <div class="left">
                        <p class="benefits-cta-headline" style="color:<?php echo $benefitsText; ?>"><?php the_field('benefits_cta_headline'); ?></p>
		...
		<div class="container skinny">
			<div class="columns">
				...
				<div class="column-full centered quote">
					...
					<p style="color:#24AAE2" class="testimonial_author"><?php the_field('testimonial_author'); ?></p>
				</div>
			</div>
		<div>
	</section>
		...
		<div class="container">
			<div class="columns">
				<div class="column-66 center">
                    ...
                    <span class="featured">Featured Result</span>
			...
			<div class="columns">
				...
				<div id="head-logo">
					<a href="/" class="custom-logo-link" rel="home" itemprop="url">
                        <img src="/wp-content/uploads/2019/09/header-img-2x.png" class="custom-logo" alt="Hecht, Kleeger &amp; Damashek, P.C." style="max-width:300px;">
					</a>
				</div>
				</div>
				<div class="column-50">
...
<?php if ( get_field('header_background_position') == 'bottom') { ?>
    <style>
        section#header {
            box-shadow: inset 130px 0px 130px 0px #000 !important;   
            background-size: calc(max(60%, 800px)) !important;
